...
const url = 'http://localhost:8000/expanses';
...
const Expanses = () => {
    ...
    const handleSubmit = async(event) =>{
        ...
        await axios.post(url+'/addexpanses',{title,amount,date,description})
        .then((res)=>{
            console.log("Expanses Added Successfully");
            setTitle("");
            setAmount("");
            setDate("");
            setDescription("");
    ...
    const handleUpdate = async(event) => {
        event.preventDefault();
        await axios.patch(url+'/updateExpanse/'+updateId,{title,amount,date,description})
        .then((res)=>{
            console.log("Expanses Updated Successfully");
            setTitle("");
            setAmount("");
            setDate("");
            setDescription("");
